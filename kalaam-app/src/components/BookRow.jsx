  ...
  return (
    ...
    >
      <div className="flex items-start md:items-center gap-3 sm:gap-6 w-full">
        {/* Serial Number */}
        <div className="text-2xl sm:text-4xl md:text-5xl font-serif font-bold text-[#FFD59F]/20 w-8 sm:w-12 md:w-16 text-center shrink-0">
          {idx + 1}
        </div>
        ...
        <div className="flex flex-col items-center w-24 sm:w-32 md:w-40 shrink-0 space-y-2 sm:space-y-3">
          ...
          <span className="font-bold font-serif text-center text-xs sm:text-sm md:text-base leading-tight w-full wrap-break-word line-clamp-2">
            {book.title}
          </span>
        </div>
        ...
        <div className="flex flex-col grow justify-between h-full py-1 sm:py-2 space-y-3 md:space-y-0 min-w-0">
          <div className="space-y-2 sm:space-y-3">
            <h4 className="text-base sm:text-lg md:text-xl text-[#FFD59F] font-semibold truncate">
              By {book.author}
            </h4>

            <div className="flex flex-wrap gap-2 items-center">
              <span className="bg-[#FFD59F]/10 px-2 sm:px-3 py-1 rounded-sm text-[9px] sm:text-[10px] md:text-xs uppercase tracking-wider font-semibold flex items-center gap-1">
                <Bookmark className="w-3 h-3" /> {book.genre}
              </span>
              <span
            ...
            <div className="bg-[#4E1A27]/50 rounded p-2 sm:p-3 border border-[#FFD59F]/10 w-fit mt-1 sm:mt-2 max-w-full">
              <p className="text-[10px] sm:text-[11px] md:text-xs text-gray-300 flex items-center flex-wrap">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 mt-3 md:mt-auto">
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              <button className="flex-3 sm:flex-none bg-[#FFD59F] text-[#4E1A27] text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 h-10 sm:h-auto rounded hover:bg-[#e6b87e] transition shadow-md flex items-center justify-center gap-2">
